...
<CardGroup cols={2}>
  <Card
    title="Core Concepts"
    icon="brain"
    href="/lomen-hub/core-concepts"
    arrow="true"
  >
    Learn about the fundamental components and principles behind Lomen Hub.
  </Card>
  <Card
    title="Datasets"
    icon="database"
    href="/lomen-hub/datasets/overview"
    arrow="true"
  >
    Discover blockchain-ready datasets that are optimized for AI training and
    inference.
  </Card>
  <Card
    title="Models"
    icon="robot"
    href="/lomen-hub/models/introduction"
    arrow="true"
  >
    Explore specialized AI models trained specifically for blockchain use cases.
  </Card>
  <Card
    title="Use Cases"
    icon="lightbulb"
    href="/lomen-hub/use-cases"
    arrow="true"
  >
    See how developers are leveraging Lomen Hub for innovative Web3
    applications.
  </Card>
</CardGroup>
