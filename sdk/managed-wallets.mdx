...
Withdrawal is the mirror image of funding:
...
<Steps>
  ...
  <Step title="Bridge back to EVM">
    Use [`bridge`](/sdk/bridging) with `sourceChain: 'solana'`, `destChain: 'base'`, and
    the user's EVM wallet as `recipient`. The managed wallet's USDC lands back on the
    user's EVM wallet.
  </Step>
</Steps>
