...
| Your own Privy | You (your Privy app) | Your backend, via Privy | [One-call](/sdk/open-position) |
| Browser EOA | The end user | The user, in the browser | [Split flow](/sdk/open-position) |
...
key. See the [one-call flow](/sdk/open-position) for the
...
[Open a Position → Split flow](/sdk/open-position).
