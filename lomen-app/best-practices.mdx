...
icon: "medal"
description: "Tips for interacting effectively with Lomen."
mode: "center"
---

To get the most accurate and helpful responses from Lomen, consider these tips:
...
- **Double-Check Confirmations:** Lomen will present transaction details for your review before execution. _Always_ carefully verify the amounts, addresses, and expected outcomes before signing any transaction in your wallet.
...
By following these practices, you can ensure Lomen understands your requests accurately and helps you navigate the blockchain world efficiently and safely.

## Give feedback to the team

- Join [our community](https://t.me/lomen_ai) and give us feedback. Lomen is a self-improving system that grows from feedback and keeps improving.
